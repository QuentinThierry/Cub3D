...
/*   Updated: 2023/12/03 14:47:46 by jvigny           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_subtitle(t_game *game, t_map *map_cell)
{
	...
	i = draw_subtitle_with_backgroud(game, game->image, first_line, narrator->subtitle + narrator->offset);
	if (*(narrator->subtitle + narrator->offset + i) != '\n'
		&& *(narrator->subtitle + narrator->offset + i) != '\0')
		draw_subtitle_with_backgroud(game, game->image, second_line, narrator->subtitle + narrator->offset + i);
}
