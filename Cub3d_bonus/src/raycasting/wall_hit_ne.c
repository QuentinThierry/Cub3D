...
/*   Updated: 2023/10/14 16:31:13 by jvigny           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline t_ray	_wall_hit_ver_ne(t_map *map_cell, t_dvector2 *hit,
...
__attribute__((always_inline))
static inline t_ray	_wall_hit_hor_ne(t_map *map_cell, t_dvector2 *hit,
						float step, float player_angle)
{
	t_dvector2	door;
